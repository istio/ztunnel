...
pub struct WorkloadData {
    ...
    workload_uid: crate::inpod::WorkloadUid,
    workload_info: Option<crate::inpod::istio::zds::WorkloadInfo>,
}

#[derive(Debug)]
pub enum WorkloadMessage {
    AddWorkload(WorkloadData),
    KeepWorkload(crate::inpod::WorkloadUid),
    WorkloadSnapshotSent,
    DelWorkload(crate::inpod::WorkloadUid),
}
