...
pub struct Socks5 {
    ...
    pub pool: Pool<super::outbound::Uniq<i32>, super::outbound::Key>,
}
...
impl Socks5 {
    pub async fn new(
        ...
        let pool: Pool<super::outbound::Uniq<i32>, super::outbound::Key> = hyper_util::client::pool::Pool::new(hyper_util::client::pool::Config {
